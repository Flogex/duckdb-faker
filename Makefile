...
BUILD_FLAGS=-DEXTENSION_STATIC_BUILD=1 $(EXTENSION_FLAGS) $(OSX_BUILD_FLAG) -DDUCKDB_EXPLICIT_PLATFORM='${DUCKDB_PLATFORM}'
...
ifeq ($(strip $(BUILD_TYPE)),)
	...
	cmake $(GENERATOR) $(BUILD_FLAGS) -DCMAKE_BUILD_TYPE=${BUILD_TYPE} -S . -B build/${BUILD_TYPE}
